    ...
    <section className="container mx-auto px-4 sm:px-6 pt-3 pb-24 md:pb-32 bg-white">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-center lg:text-left animate-on-scroll">
                 <h1 className="font-barlow font-bold text-4xl sm:text-5xl lg:text-6xl text-[var(--color-primary)] leading-tight">MUA THÔNG MINH<br/>DÙNG BỀN VỮNG<br/>MẶC CÓ TRÁCH NHIỆM</h1>
